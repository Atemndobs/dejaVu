...
export default ({ app, router, store, Vue }) => {
  ...
  */
      ...
      children: [
        {
          path: 'verify',
          name: 'verify',
          component: () => import('http-authentication/pages/verification/Verify')
        },
        {
          path: 'resend',
          name: 'resend',
          component: () => import('http-authentication/pages/verification/Resend')
        }
      ]
    },
    {
  ...
  helper.verificationResend = (data) => { return store.dispatch('auth/verificationResend', data) }
