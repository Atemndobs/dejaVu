...
const VERIFICATION_RESEND_ROUTE = prompts['http-authentication'].resendVerificationRoute
...
export function verificationResend (state, data) {
  return axiosInstance.post(VERIFICATION_RESEND_ROUTE, data)
}
